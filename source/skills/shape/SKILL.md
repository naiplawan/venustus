...
Invoke {{command_prefix}}venustus, which contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding. If no design context exists yet, you MUST run {{command_prefix}}venustus teach first.
...
**Output**: A design brief that can be handed off to {{command_prefix}}venustus craft, {{command_prefix}}venustus, or any other implementation skill.
...
**3. Design Direction**
How this should feel. What aesthetic approach fits. Reference the project's design context from `.venustus.md` and explain how this feature should express it.
...
Based on the brief, list which venustus reference files would be most valuable during implementation (e.g., spatial-design.md for complex layouts, motion-design.md for animated features, interaction-design.md for form-heavy features).
...
Once confirmed, the brief is complete. The user can now hand it to {{command_prefix}}venustus craft to build the feature, or use it to guide any other implementation approach.
