/**
 * Venustus DevTools Extension - DevTools Page
 *
 * Creates the Venustus panel and triggers an auto-scan when DevTools opens.
...
chrome.devtools.panels.elements.createSidebarPane('Venustus', (sidebar) => {
...
const portName = `venustus-devtools-${chrome.devtools.inspectedWindow.tabId}`;
...
function connectLifecycle() {
  ...
  // Default ('panel'): wait until the user opens the Venustus panel or sidebar.
