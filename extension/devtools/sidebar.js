/**
 * Venustus DevTools Extension - Elements Sidebar Pane
 *
 * Shows Venustus findings for the currently selected element ($0) in the Elements panel.
 */
...
function getPort() {
  if (port) return port;
  port = chrome.runtime.connect({ name: `venustus-sidebar-${tabId}` });
