---
name: venustas-overdrive
description: Pushes interfaces past conventional limits with technically ambitious implementations — shaders, spring physics, scroll-driven reveals, 60fps animations, View Transitions, WebGL effects. Use when the user wants to wow, impress, go all-out, make something feel extraordinary, or says "make this amazing", "blow me away", "push the limits", or "I want this to feel like a native app". For aesthetic amplification without advanced tech, use /bolder instead.
user-invocable: true
