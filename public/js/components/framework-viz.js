...
const commandNumbers = {
	'shape': 0,
	'venustus craft': 1, 'venustus': 2, 'onboard': 3, 'overdrive': 4,
	'critique': 5, 'audit': 6,
	...
	'venustus teach': 21, 'extract': 22
};

// Map sub-commands to their display label and scroll target
const commandDisplay = {
	'venustus craft': { label: '/venustus craft', scrollTo: 'venustus' },
	'venustus teach': { label: '/venustus teach', scrollTo: 'venustus' },
};
