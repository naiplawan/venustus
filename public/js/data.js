...
export const readySkills = [
  'venustus'  // Consolidated skill with all design domains
];
...
// Consolidated venustus skill with reference domains
...
// Reference domains within the venustus skill
...
export const commandProcessSteps = {
  ...
  'venustus craft': ['Shape', 'Reference', 'Build', 'Iterate'],
  'venustus': ['Direct', 'Design', 'Build', 'Refine'],
  ...
  'venustus teach': ['Explore', 'Interview', 'Synthesize', 'Save'],
...
export const commandCategories = {
  ...
  'venustus teach': 'system',
  'extract': 'system'
};

// Skill relationships - now consolidated into venustus skill
// The venustus skill contains all domains as reference files
...
export const commandRelationships = {
  'shape': { flow: 'Create: Plan UX and UI through structured discovery', leadsTo: ['venustus craft'] },
  'venustus craft': { flow: 'Create: Full shape-then-build flow with visual iteration' },
  'venustus': { flow: 'Create: Freeform design with full design intelligence' },
  ...
  'venustus teach': { flow: 'System: One-time project design context setup' },
