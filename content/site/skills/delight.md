...
The skill reads the brand tone from `.venustus.md`. A serious analytics tool gets serious delight (dry, precise, a little clever). A playful consumer app gets more overt personality. It does not force humor where humor is wrong for the audience.
...
- **Forcing humor.** Not every brand is playful. If the brand voice in `.venustus.md` is "clinical and precise", delight adds clever restraint, not jokes.
