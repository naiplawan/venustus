...
The skill uses the audience and mental state from `.venustus.md` to tune voice. Technical audience gets precise language. Consumer audience gets plain speech. Rushed users get short text. Anxious users (payment, delete) get reassurance.
...
- **Skipping the audience question.** Clarify needs to know who is reading. If `.venustus.md` does not specify audience technical level, the rewrites will be generic.
