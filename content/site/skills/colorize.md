...
- **Running it without a brand hue.** Colorize needs a starting point. If `.venustus.md` does not specify one, it will ask. Do not let it pick from the AI color palette defaults.
