...
- **Asking for a new font without context.** Typeset will pick based on the `.venustus.md` brand voice. If you have not run `/venustus teach`, the suggestion will be generic.
