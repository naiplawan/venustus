 ...
 *
 *  3. LLM_ONLY_RULES: DON'T lines from source/skills/venustus/SKILL.md
 ...
 *
 *  'cli':     static analysis or jsdom (works with `npx venustus detect`
...
export const LAYER_DESCRIPTIONS = {
  cli: 'Deterministic. Runs from `npx venustus detect` on files, no browser required.',
...
/**
 * Anti-patterns that live in the /venustus skill's DON'T list but
